...
<body>
 <h2>What change would you like to make to your Vehicles, <%=session.getAttribute("firstName").toString()%>?</h2> 
<%
...
%>
	...
	<input type="number" name="passengerCapacity" placeholder ="Number of Passengers" min="0" max="10">
		<br><br>
	<input type="button" name = "decision" value="Add Vehicle">
		<br><br>
				
	<h3>--Delete Vehicle Information--</h3>	
	...
	results.beforeFirst();%>
		...
		<br><br>
	<input type="button" name = "decision" value="Delete Vehicle">
		<br><br>
